<div class="profile">
    ...
    <h1 class="text-light"><a href="index.html">Agis</a></h1>
    <div class="social-links mt-3 text-center">
        ...
        <a href="https://www.instagram.com/agis_suryana990" target="_blank" class="instagram"><i class="bx bxl-instagram"></i></a>
